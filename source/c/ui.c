...
const unsigned char twisted_end_8[] = "To live, to play, to make!";
const unsigned char twisted_end_9[] = "Far better to make\nimperfectly, ";
const unsigned char twisted_end_10[] = "to make with your\nown sweat,";
...
const unsigned char twisted_end_14[] = "All things fade, in time.";
const unsigned char twisted_end_15[] = "But marks made\nwith your feelings...";
