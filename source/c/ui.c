...
const unsigned char twisted_end_2[] = "You couldn't have performed\nany other action.";
const unsigned char twisted_end_3[] = "Except to turn away,\nto doom me to the void!";
...
const unsigned char twisted_end_7[] = "... to live within\nyour constraints.";
const unsigned char twisted_end_8[] = "Our limits are a part\nof us, after all.";
const unsigned char twisted_end_9[] = "They make us what we are.";
const unsigned char twisted_end_10[] = "And so to push forward,";
const unsigned char twisted_end_11[] = "grazing the borders\nof your SOUL's limits,";
const unsigned char twisted_end_12[] = "is a beautiful thing.";
const unsigned char twisted_end_13[] = "...";
const unsigned char twisted_end_14[] = "All things must fade,\nin time.";
const unsigned char twisted_end_15[] = "But the marks made\nwith your feelings...";
const unsigned char twisted_end_16[] = "...with your own hands..?";
const unsigned char twisted_end_17[] = "They fade the slowest.";
const unsigned char twisted_end_18[] = "Better to be true,\nand be found imperfect...";
const unsigned char twisted_end_19[] = "... than to be perfect,\nbut not yourself.";
