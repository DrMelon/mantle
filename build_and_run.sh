...
python scripts/convert_ldtk.py ldtk_proj/mantle_dungeon.ldtk source/c/dungeon_maps
python scripts/convert_ldtk.py ldtk_proj/mantle_shelter_ext.ldtk source/c/forest_maps
python scripts/convert_ldtk.py ldtk_proj/mantle_shelter_int.ldtk source/c/shelter_maps
